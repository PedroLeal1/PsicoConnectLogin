...
export default function DashboardPage() {
  ...
  return (
    <div className="p-0">
      ...
      <div className="space-y-4 bg-white p-6 rounded-lg shadow-md mb-8">
      ...
      {isPsychologist && (
        <div className="bg-white p-6 rounded-lg shadow-md border border-slate-100">
          ...
          <p className="text-gray-600 mb-4">
            Aceda à sua agenda para visualizar compromissos e integrar com o
            Google Agenda.
          </p>

          <Link
            href="/agenda"
            className="inline-flex items-center gap-2 bg-blue-700 hover:bg-blue-800 text-white font-semibold px-4 py-2 rounded-lg transition"
          >
